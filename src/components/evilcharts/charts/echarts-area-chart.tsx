...
export interface YAxisProps {
  ...
  /** When true, axis does not force 0 into the range (zooms to data). */
  scale?: boolean;
}
...
function buildMainAxes(ctx: OptionBuildContext): { xAxis: XAxisOption; yAxis: YAxisOption } {
  ...
  const yAxis: YAxisOption = {
    ...
    // Zoom to data by default so small equity dips aren't flattened against $0.
    scale: isExpanded ? false : (yAxisSlot.scale ?? true),
